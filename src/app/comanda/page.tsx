    ...
    <PageWrapper>
      <div className="overflow-x-clip h-auto flex flex-col justify-center items-center gap-20 bg-black text-yellowCustom py-48P w-full xl:flex-row xl:gap-0 xl:py-0 xl:h-[100dvh]">
          ...
          {itemsInCart.length === 0 ? (
            ...
            <ul className="w-full max-w-container-600">
              ...
              <li className="flex justify-between items-center gap-10">
                <div className="underline">Plata se face cash la livrare</div>
                <button
                  onClick={() => golesteLista()}
                  id="important2"
                  className="cursor-pointer hover:scale-105 no-underline"
                >
                  Goleste Cos
                </button>
              </li>
        ...
        >
          ...
          />
          {fieldErrors.nume && (
            <p id="important" className="text-sm mt-1  mb-16M text-red-500">
              {fieldErrors.nume}
            </p>
          )}
          <input
          ...
          />
          {fieldErrors.adresa && (
            <p id="important" className="text-sm mt-1  mb-16M">
              {fieldErrors.adresa}
            </p>
          )}
          <input
